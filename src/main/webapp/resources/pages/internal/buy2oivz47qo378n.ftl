...
<form action="/Registration/add" method="post">
    <div class="title-box">
        <table style="width:100%">
            <tr>
                <td><img id="enter-img" src="/images/2oivz47qo378n.jpg"></td>
                <td id="title-td" class="title-des">
                    <div class="title-name">滑水夏令营</div>
                    <div class="title-age">时间：7月4日-8月26日</div>
                    <div class="title-price">￥4800</div>
                    <input type="hidden" name="dealName" id="dealName" value="滑水夏令营">
                    <input type="hidden" name="dealId" id="dealId" value="2oivz47qo378n">
                    <input type="hidden" name="totalAmount" id="totalAmount" value="4800">
                    <input type="hidden" name="userAmount" id="userAmount" value="4800">
                </td>
            </tr>
        </table>
    </div>
        ...
        <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="step-desc" align="center" valign="middle">
                    合计：<span class="confirm-price">￥4800</span>
                </td>
