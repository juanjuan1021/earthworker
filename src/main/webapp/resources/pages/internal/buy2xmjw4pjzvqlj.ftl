...
<form action="/Registration/add" method="post">
    <div class="title-box">
        <table style="width:100%">
            <tr>
                <td><img id="enter-img" src="/images/2xmjw4pjzvqlj.jpg"></td>
                <td id="title-td" class="title-des">
                    <div class="title-name">小小厨王夏令营</div>
                    <div class="title-age">时间：7月4日-8月19日</div>
                    <div class="title-price">￥3980</div>
                    <input type="hidden" name="dealName" id="dealName" value="小小厨王夏令营">
                    <input type="hidden" name="dealId" id="dealId" value="2xmjw4pjzvqlj">
                    <input type="hidden" name="totalAmount" id="totalAmount" value="3980">
                    <input type="hidden" name="userAmount" id="userAmount" value="3980">
                </td>
            </tr>
        </table>
    </div>
        ...
        <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="step-desc" align="center" valign="middle">
                    合计：<span class="confirm-price">￥3980</span>
                </td>
