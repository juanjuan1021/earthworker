...
<form action="/Registration/add" method="post">
    <div class="title-box">
        <table style="width:100%">
            <tr>
                <td><img id="enter-img" src="/images/1yga6omzdjx47.jpg"></td>
                <td id="title-td" class="title-des">
                    <div class="title-name">帆船夏令营</div>
                    <div class="title-age">时间：6月20日-8月26日</div>
                    <div class="title-price">￥3980</div>
                    <input type="hidden" name="dealName" id="dealName" value="帆船夏令营">
                    <input type="hidden" name="dealId" id="dealId" value="1yga6omzdjx47">
