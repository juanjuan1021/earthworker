...
<form action="/Registration/add" method="post">
    <div class="title-box">
        <table style="width:100%">
            <tr>
                <td><img id="enter-img" src="/images/1y2p6l9a6ki6v.jpg"></td>
                <td id="title-td" class="title-des">
                    <div class="title-name">德国深度教育体验夏令营</div>
                    <div class="title-age">时间：7月16日-7月26日</div>
                    <div class="title-price">￥35800</div>
                    <input type="hidden" name="dealName" id="dealName" value="德国深度教育体验夏令营">
                    <input type="hidden" name="dealId" id="dealId" value="1y2p6l9a6ki6v">
                    <input type="hidden" name="totalAmount" id="totalAmount" value="35800">
                    <input type="hidden" name="userAmount" id="userAmount" value="35800">
                </td>
            </tr>
        </table>
    </div>
        ...
        <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="step-desc" align="center" valign="middle">
                    合计：<span class="confirm-price">￥35800</span>
                </td>
