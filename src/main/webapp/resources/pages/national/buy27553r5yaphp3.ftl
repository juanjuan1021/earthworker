...
<form action="/Registration/add" method="post">
    <div class="title-box">
        <table style="width:100%">
            <tr>
                <td><img id="enter-img" src="/images/27553r5yaphp3.jpg"></td>
                <td id="title-td" class="title-des">
                    <div class="title-name">美国新英格兰LS&LZ经典亲子徒步游</div>
                    <div class="title-age">时间：7月9日-8月29日</div>
                    <div class="title-price">￥42000</div>
                    <input type="hidden" name="dealName" id="dealName" value="美国新英格兰LS&LZ经典亲子徒步游">
                    <input type="hidden" name="dealId" id="dealId" value="27553r5yaphp3">
                    <input type="hidden" name="totalAmount" id="totalAmount" value="42000">
                    <input type="hidden" name="userAmount" id="userAmount" value="42000">
                </td>
            </tr>
        </table>
    </div>
        ...
        <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="step-desc" align="center" valign="middle">
                    合计：<span class="confirm-price">￥42000</span>
                </td>
