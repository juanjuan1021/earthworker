...
<form action="/Registration/add" method="post">
    <div class="title-box">
        <table style="width:100%">
            <tr>
                <td><img id="enter-img" src="/images/273wewwtd8n3r.jpg"></td>
                <td id="title-td" class="title-des">
                    <div class="title-name">悉尼航海国际夏令营</div>
                    <div class="title-age">时间：7月24日-8月16日</div>
                    <div class="title-price">￥29800</div>
                    <input type="hidden" name="dealName" id="dealName" value="悉尼航海国际夏令营">
                    <input type="hidden" name="dealId" id="dealId" value="273wewwtd8n3r">
                    <input type="hidden" name="totalAmount" id="totalAmount" value="29800">
                    <input type="hidden" name="userAmount" id="userAmount" value="29800">
                </td>
            </tr>
        </table>
    </div>
        ...
        <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="step-desc" align="center" valign="middle">
                    合计：<span class="confirm-price">￥29800</span>
                </td>
