...
<form action="/Registration/add" method="post">
    <div class="title-box">
        <table style="width:100%">
            <tr>
                <td><img id="enter-img" src="/images/2fleh32z5zbtz.jpg"></td>
                <td id="title-td" class="title-des">
                    <div class="title-name">哈利波特魔法主题夏令营</div>
                    <div class="title-age">时间：7月下旬-8月上旬</div>
                    <div class="title-price">￥34800</div>
                    <input type="hidden" name="dealName" id="dealName" value="哈利波特魔法主题夏令营">
                    <input type="hidden" name="dealId" id="dealId" value="2fleh32z5zbtz">
                    <input type="hidden" name="totalAmount" id="totalAmount" value="34800">
                    <input type="hidden" name="userAmount" id="userAmount" value="34800">
                </td>
            </tr>
        </table>
    </div>
        ...
        <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="step-desc" align="center" valign="middle">
                    合计：<span class="confirm-price">￥34800</span>
                </td>
