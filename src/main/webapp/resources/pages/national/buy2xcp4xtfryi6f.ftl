        ...
        <table style="width:100%">
            <tr>
                ...
                <td id="title-td" class="title-des">
                    ...
                    <input type="hidden" name="dealName" id="dealName" value="行远之牛津锐思暑期学校">
                    <input type="hidden" name="dealId" id="dealId" value="2xcp4xtfryi6f">
                    <input type="hidden" name="totalAmount" id="totalAmount" value="1">
                    <input type="hidden" name="userAmount" id="userAmount" value="1">
                </td>
            </tr>
        </table>
    </div>
        ...
        <table style="width: 100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="step-desc" align="center" valign="middle">
                    合计：<span class="confirm-price">营费待定</span>
                </td>
